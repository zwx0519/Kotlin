...
import androidx.databinding.library.baseAdapters.BuildConfig.LIBRARY_PACKAGE_NAME
...
//            process = new ProcessBuilder("pm", "install", "-r", apkPath).start();
            ...
            process = if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
                ...
                ProcessBuilder("pm", "install", "-i", BuildConfig.APPLICATION_ID, "-r", apkPath).start()
            }
